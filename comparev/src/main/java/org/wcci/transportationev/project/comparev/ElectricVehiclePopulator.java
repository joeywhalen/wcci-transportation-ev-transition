package org.wcci.transportationev.project.comparev;

import org.springframework.boot.CommandLineRunner;
import org.springframework.stereotype.Component;
import org.wcci.transportationev.project.comparev.resources.ElectricVehicle;
import org.wcci.transportationev.project.comparev.storage.ElectricVehicleStorage;
...
public class ElectricVehiclePopulator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        ElectricVehicle audiA6Etron = new ElectricVehicle("Audi", "A6 e-tron", "Minnie Mink", "Sedan", 80000, true, 725,
                400, 80, 5.1, 125, "AWD", 10, 30, 5, false, true, false, 29.5, 3, 4.5, false, "./images/ev19.jpg",
        ...
        ElectricVehicle audiETronSB = new ElectricVehicle("Audi", "e-tron Sportback", "Cliff Booth", "Sedan", 69100,
                true, 725, 218, 77, 5.5, 118, "AWD", 10, 30, 5, false, true, false, 27.2, 3, 4.5, false,
                "./images/ev01.jpg",
        ...
        ElectricVehicle bmwIFour = new ElectricVehicle("BMW", "I4", "Patrick Bateman", "Sedan", 56395, true, 725, 300,
                90, 5.7, 118, "RWD", 8.75, 30, 5, false, true, true, 16.6, 0, 4.5, true, "./images/ev20.jpg",
        ...
        ElectricVehicle bmwIX = new ElectricVehicle("BMW", "IX", "Timothy Bryce", "Crossover", 84194, true, 725, 300,
                85, 4.6, 124, "AWD", 11, 35, 5, false, true, true, 27.4, 0, 4.5, true, "./images/ev21.jpg",
        ...
        ElectricVehicle bollingerBTwo = new ElectricVehicle("Bollinger", "B2", "Paul Allen", "Truck", 125000, true, 725,
                200, 70, 4.5, 100, "AWD", 10, 75, 4, false, false, false, 86, 8.0, 4.0, false, "./images/ev22.jpg",
        ...
        ElectricVehicle caddyLyriq = new ElectricVehicle("Cadillac", "Lyriq", "Sean Bateman", "Crossover", 59995, true,
                725, 300, 80, 4.3, 130, "RWD", 6, 35, 7, true, true, true, 12.6, 0, 4.5, false, "./images/ev23.jpg",
        ...
        ElectricVehicle chevyBolt = new ElectricVehicle("Chevrolet", "Bolt", "Mia Wallace", "Crossover", 37500, false,
                725, 247, 120, 7.0, 93, "FWD", 7.5, 60, 5, true, true, false, 16.6, 0, 5.0, false, "./images/ev02.jpg",
        ...
        ElectricVehicle fordLightning = new ElectricVehicle("Ford", "F-150 Lightning", "Lauren Hynde", "Truck", 42000,
                true, 725, 230, 75, 4.5, 100, "AWD", 8, 44, 5, true, true, true, 80, 14.1, 5.0, true,
                "./images/ev24.jpg",
        ...
        ElectricVehicle fordMustang = new ElectricVehicle("Ford", "Mustang Mach-E Select (eAWD)", "Vincent Vega",
                "Crossover", 42895, true, 725, 211, 90, 5.2, 130, "e-AWD", 14, 52, 5, false, true, true, 29.7, 4.7, 5.0,
                true, "./images/ev03.jpg",
        ...
        ElectricVehicle genesisGEighty = new ElectricVehicle("Genesis", "G80", "Paul Denton", "Sedan", 50000, true, 725,
                310, 90, 4.8, 100, "e-AWD", 9, 22, 5, false, true, false, 13.1, 0, 4.5, true, "./images/ev25.jpg",
        ...
        ElectricVehicle gmcHummer = new ElectricVehicle("GMC", "Hummer EV", "Jimmy McNulty", "Truck", 79995, true, 725,
                350, 75, 3.0, 100, "AWD", 12, 30, 5, true, true, false, 80, 11.3, 4.5, true, "./images/ev26.jpg",
        ...
        ElectricVehicle hyundaiIoniq = new ElectricVehicle("Hyundai", "Ioniq", "Joe Cabot", "Sedan", 33245, true, 725,
                170, 133, 10, 102, "FWD", 5.8, 60, 5, false, true, false, 23, 0, 4.0, false, "./images/ev04.jpg",
        ...
        ElectricVehicle hyundaiIoniqFive = new ElectricVehicle("Hyundai", "Ioniq 5", "William 'Bunk' Moreland",
                "Crossover", 45000, true, 725, 225, 125, 5.2, 115, "AWD", 7.75, 18, 5, false, true, false, 18.8, 0.85,
                4.5, true, "./images/ev27.jpg",
        ...
        ElectricVehicle hyundaiKona = new ElectricVehicle("Hyundai", "Kona", "Alabama Whitman", "Crossover", 37900,
                true, 725, 258, 120, 6.4, 96, "FWD", 9, 54, 5, false, true, false, 19.2, 0, 5.0, false,
                "./images/ev05.jpg",
        ...
        ElectricVehicle jaguarIpace = new ElectricVehicle("Jaguar", "I-Pace", "Mallory Knox", "Crossover", 69900, true,
                725, 234, 76, 4.5, 124, "AWD", 10.2, 90, 5, false, true, true, 23.2, 1.0, 5.0, false,
                "./images/ev06.jpg",
        ...
        ElectricVehicle jeepMagneto = new ElectricVehicle("Jeep", "Wrangler Magneto", "Shakima Greggs", "Crossover",
                52500, true, 725, 200, 95, 6.8, 120, "AWD", 9, 45, 4, false, true, false, 17, 0, 4.0, false,
                "./images/ev28.jpg",
        ...
        ElectricVehicle kiaEvSix = new ElectricVehicle("Kia", "EV6", "Lester Freamon", "Crossover", 45000, true, 725,
                270, 110, 5.2, 115, "RWD", 7, 18, 5, false, true, false, 28, 0, 4.5, true, "./images/ev29.jpg",
        ...
        ElectricVehicle kiaNiro = new ElectricVehicle("Kia", "Niro", "Seth Gecko", "Crossover", 39090, true, 725, 239,
                112, 6.5, 103, "FWD", 9.5, 60, 5, false, true, false, 18.5, 0, 5.0, false, "./images/ev07.jpg",
        ...
        ElectricVehicle lucidAir = new ElectricVehicle("Lucid", "Air Touring", "Kate Fuller", "Sedan", 87500, true, 725,
                406, 100, 3.2, 168, "AWD", 6, 20, 5, false, true, true, 26.1, 9.9, 4.5, true, "./images/ev08.jpg",
        ...
        ElectricVehicle mazdaMx = new ElectricVehicle("Mazda", "MX-30", "Kate Austen", "Crossover", 38000, true, 725,
                130, 100, 9, 90, "RWD", 5, 30, 5, false, true, false, 28, 0, 4.5, false, "./images/ev30.jpg",
        ...
        ElectricVehicle mercedesEqa = new ElectricVehicle("Mercedes-Benz", "EQA", "Reginald 'Bubbles' Cousins",
                "Crossover", 57000, true, 725, 250, 100, 7.0, 99, "AWD", 7.25, 35, 5, false, true, false, 12, 0, 4.5,
                true, "./images/ev31.jpg",
        ...
        ElectricVehicle miniCooperSE = new ElectricVehicle("Mini Cooper", "SE", "Santanico Pandemonium", "Sedan", 29900,
                true, 725, 114, 108, 6.9, 93, "FWD", 4, 36, 4, false, true, false, 8.7, 0, 4.0, false,
                "./images/ev09.jpg", "https://cdn.motor1.com/images/mgl/kNN7x/s1/mini-cooper-se.jpg",
        ...
        ElectricVehicle nissaAriya = new ElectricVehicle("Nissan", "Ariya", "Russell 'Stringer' Bell", "Crossover",
                40000, true, 725, 300, 105, 7.5, 99, "FWD", 10, 31, 5, true, true, false, 16.5, 0, 4.5, false,
                "./images/ev32.jpg", "https://cdn.mos.cms.futurecdn.net/ARwne5T6bP4KnybiqG59qc.jpg",
        ...
        ElectricVehicle nissanLeaf = new ElectricVehicle("Nissan", "Leaf S Plus", "Max Cherry", "Crossover", 37400,
                true, 725, 226, 114, 7.4, 90, "FWD", 11, 60, 5, false, true, false, 23.6, 0, 5.0, false,
                "./images/ev10.jpg", "https://cdn.motor1.com/images/mgl/42lOZ/s1/2021-nissan-leaf.jpg",
        ...
        ElectricVehicle polestarTwo = new ElectricVehicle("Polestar", "Two", "Ray Nicolette", "Crossover", 59900, true,
                725, 233, 92, 4.5, 127, "AWD", 8, 47, 5, false, true, true, 14.3, 1.23, 5.0, true, "./images/ev11.jpg",
        ...
        ElectricVehicle porscheTaycan = new ElectricVehicle("Porsche", "Taycan", "Elle Driver", "Sedan", 103800, true,
                725, 200, 69, 3.4, 155, "RWD", 12, 15, 4, false, true, true, 12.9, 2.8, 5.0, false, "./images/ev12.jpg",
                "https://i.insider.com/5f36af5fe89ebf001f04496b?width=1136&format=jpeg",
        ...
        ElectricVehicle rivianROneT = new ElectricVehicle("Rivian", "R1T", "Omar Little", "Truck", 73000, true, 725,
                300, 80, 3.0, 100, "AWD", 10, 35, 5, true, true, true, 57, 11.0, 4.5, false, "./images/ev33.jpg",
        ...
        ElectricVehicle teslaCybertruck = new ElectricVehicle("Tesla", "Cybertruck", "James ‘Sawyer’ Ford", "Truck",
                70000, false, 725, 500, 90, 3.0, 130, "AWD", 10, 44, 6, true, true, true, 90, 10.0, 5.0, true,
                "./images/ev34.jpg", "https://www.tesla.com/xNVh4yUEc3B9/10_Desktop.jpg",
        ...
        ElectricVehicle teslaThree = new ElectricVehicle("Tesla", "Model 3 SR+", "Aldo Raine", "Sedan", 39900, false,
                725, 263, 133, 5.3, 140, "RWD", 5.5, 21, 5, true, true, true, 18, 5, 5.0, true, "./images/ev13.jpg",
        ...
        ElectricVehicle teslaSPlaid = new ElectricVehicle("Tesla", "Model S Plaid", "Bridget Von Hammersmark", "Sedan",
                129990, false, 725, 396, 101, 1.99, 200, "AWD", 6.5, 27, 5, true, true, true, 25, 3, 5.0, true,
                "https://i.insider.com/605ce29e106eb50019d05a89?width=700", "./images/ev14.jpg",
        ...
        ElectricVehicle teslaX = new ElectricVehicle("Tesla", "Model X LR", "Calvin Candie", "Crossover", 94990, false,
                725, 360, 96, 3.8, 155, "AWD", 12, 22, 7, true, true, true, 83, 5, 5.0, true, "./images/ev15.jpg",
        ...
        ElectricVehicle teslaY = new ElectricVehicle("Tesla", "Model Y LR", "Marquis Warren", "Crossover", 53990, false,
                725, 326, 121, 4.8, 135, "AWD", 10, 40, 5, true, true, true, 71, 5, 5.0, true, "./images/ev16.jpg",
        ...
        ElectricVehicle teslaRoadsterTwo = new ElectricVehicle("Tesla", "Roadster 2", "Dr. Jack Shephard", "Sedan",
                200000, false, 725, 620, 90, 1.9, 250, "AWD", 8, 44, 4, true, true, true, 15, 4.0, 5.0, true,
                "./images/ev35.jpg",
        ...
        ElectricVehicle volksIdFour = new ElectricVehicle("Volkswagen", "ID.4", "Chris Mannix", "Crossover", 44495,
                true, 725, 250, 99, 5.7, 112, "AWD", 7.5, 38, 5, false, true, true, 30, 0, 4.5, false,
                "./images/ev17.jpg",
        ...
        ElectricVehicle volvoXcForty = new ElectricVehicle("Volvo", "XC40 Recharge", "Joe Gage", "Crossover", 53990,
                true, 725, 208, 80, 4.3, 112, "AWD", 11, 40, 5, false, true, true, 20, 5, 5.0, true,
                "./images/ev18.jpg",
