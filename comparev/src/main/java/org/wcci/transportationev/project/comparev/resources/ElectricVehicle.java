...
public class ElectricVehicle {
    ...
    public ElectricVehicle(String makeName, String modelName, String authorName, String vehicleType, int msrp,
            boolean taxCredit, double yearlyMaintenanceCost, int range, int mpgE, double zeroToSixty, int topSpeed,
            String wheelDrive, double homeCharge, int travelCharge, int seating, boolean autonomous,
            boolean driverAssist, boolean freeOtaUpdate, double rearCargoSpace, double frunkSpace, double safetyRating,
            boolean phoneKey, String imageUrl, String imageUrl2, String reviewContent, String... reviewComments) {
